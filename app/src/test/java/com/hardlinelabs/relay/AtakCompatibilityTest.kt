...
class AtakCompatibilityTest {
    @Test
    fun largestTextTransportEnvelopeFitsPinnedMeshtasticDataLimit() {
        val data =
    ...
    @Test
    fun corePortFilterBlocksPrivateTrafficAndMissingSettingsAreNotGreen() {
        val result =
            AtakCompatibility.settings(
                LocalConfig(
                    device =
                        Config.DeviceConfig(
                            rebroadcast_mode =
