...
Offline private-channel management for Meshtastic, with a companion ATAK plugin.
...
Create several contingency channels, share a QR, and choose when to activate each.
